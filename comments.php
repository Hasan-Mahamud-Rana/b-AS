	...
	<li <?php comment_class(); ?>>
		<article id="comment-<?php comment_ID(); ?>">
			...
			<?php if ($comment->comment_approved == '0') : ?>
       			<div class="notice">
					<p class="bottom"><?php _e('Din kommentar afventer godkendelse.', 'reverie') ?></p>
          		</div>
			<?php endif; ?>
...
<?php if ( have_comments() ) : ?>
	<section id="comments" class="small-12 columns">
		<h3><?php comments_number(__('Ingen kommentarer til', 'reverie'), __('Èn kommentar til', 'reverie'), __('% kommentarer til', 'reverie') ); ?> &#8220;<?php the_title(); ?>&#8221;:</h3>
		...
		<footer>
			<nav id="comments-nav">
				<div class="comments-previous"><?php previous_comments_link( __( '&larr; Ældre kommentarer', 'reverie' ) ); ?></div>
				<div class="comments-next"><?php next_comments_link( __( 'Nyere kommentarer &rarr;', 'reverie' ) ); ?></div>
			</nav>
		</footer>
	</section>
<?php else : // this is displayed if there are no comments so far ?>
	...
	<section id="comments" class="small-12 columns">
		<div class="notice">
			<p class="bottom"><?php _e('Lukket for kommentarer.', 'reverie') ?></p>
		</div>
	</section>
	<?php endif; ?>
<?php endif; ?>
...
<section id="respond" class="small-12 columns">
	<h3><?php comment_form_title( __('Skriv en kommentar', 'reverie'), __('Skriv en kommentar til %s', 'reverie') ); ?></h3>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p>
			<label for="email"><?php _e('Email (bliver ikke offentliggjort)', 'reverie'); if ($req) _e(' (required)', 'reverie'); ?></label>
		...
		<?php endif; ?>
		<p>
			<label for="comment"><?php _e('Kommentar', 'reverie'); ?></label>
		...
		<p><input name="submit" class="small radius button" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e('Indsend kommentar', 'reverie'); ?>"></p>
