...
if( ! function_exists( 'reverie_scripts_and_styles ' ) ) {
	function reverie_scripts_and_styles() {
	  if (!is_admin()) {
	    ...
	    // register Google font - Normal text
	    wp_register_style('google-font-normal', 'http://fonts.googleapis.com/css?family=Open+Sans:400,800,600');

	    // register Google font - Headings
	    wp_register_style('google-font-headings', 'http://fonts.googleapis.com/css?family=Titillium+Web:400,700,600');
	    ...
	    wp_enqueue_style( 'google-font-normal' );
